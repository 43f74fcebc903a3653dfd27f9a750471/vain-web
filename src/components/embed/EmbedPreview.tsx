...
export const EmbedPreview = ({ embed, content, script }: EmbedPreviewProps) => (
  <div className="bg-black/20 border border-white/[0.08] rounded-md shadow-md overflow-hidden">
    <div className="border-b border-white/[0.08] px-4 py-3">
      <div className="flex items-center">
        <div className="p-1.5 rounded-md bg-black/30 border border-white/20 mr-2">
          <FiEye className="w-4 h-4 text-vain-primary/80" />
        </div>
    ...
    <div className="p-4">
      ...
      <div className="mt-6 bg-black/20 border border-white/[0.08] p-4 rounded-md">
        <h3 className="text-white font-medium mb-2">Generated script</h3>
        <p className="p-3 rounded-md text-white/90 text-sm font-mono overflow-auto">
          {script}
        </p>
      </div>
    </div>
